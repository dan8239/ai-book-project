...
Damon threw his headset off and he was back in Grant's office. He shoved his device across the desk. His watch buzzed against his wrist as it restarted — he clawed it off like it had bitten him and left it where it fell.
...
"Not yet. The site is too large for the maintenance budget. Cut the top 40% of the terraces until yield is stable. Make sure the spillways can handle a 100 year storm, this can't be more than 25 year storm design. Add more redundant water basins as well, then we'll work to optimize the polyculture mix again."
...
BOOM. BOOM. BOOM. A child's voice was carrying through the mountains. "DADDY, DADDY, DADDY". Two of the buttons on Dorothea's shirt fastened, and her jeans grew a size.
...
"If you're ever a professional again I'll adjust as needed. Would you like to continue your job search? I've reduced 115k potential matches down to the 3 most promising based on your past rejections. One in particular is *fantastic*, exactly what you've been looking for."
...
Glenn read Sam's interest correctly and continued. "It's an optimization contract, with a human-in-the-loop requirement. Standard driver-controller arrangement. NDA before specifics, naturally. But the broad strokes — we're building self-replicating ships. Civboats. Each one carries a genetic payload, flora, fauna, the works. Portable ecosystems, launched toward habitable stars. Your job is to make the math work. Which payloads, which targets, what trade-offs. The budget is —" he paused, searching for the right word, "— obscene."
...
Dorothea took the lead automatically. "I've already pulled his clearance — level 2, still active. And his biome optimization work for the Cascadia food chain directive is directly applicable. He solved a multi-variable resource allocation problem across eleven agricultural zones with incomplete data. Genetic diversity constraints, shifting yield targets, cascading failure modes." She looked over at Sam. "Sound familiar?"
...
"Nothing too crazy. I cloned the quant-blitz-xl-12.7? Maybe it was 8? Either way it was about 6 years ago. I set her up to log every interaction. I have a second model from a different family measure rewards for every interaction nightly, and I schedule her to fine-tune her policy while I sleep. The reward quantification is kind of tricky, actually.."

<!-- don't trail off above, have him give an actual detail here... This reward function makes Dorothea who she is, and why she eventually takes control in the end. This is her genesis story seed, so don't waste the reference-->
...
Glenn smiled at that, an almost cartoonish, emoji grin. "None taken. Reality is relative, I've come to find. And I wouldn't worry about your own perceived shortcomings too much. Many eggs, many baskets, my friend. Why don't you sleep on it, I'll send over the smart contract. Let me know in the next 24 hours."

Sam stood and shook Glenn's hand, then turned up the cuff of his mesh beanie and he was back in his office. The concave sides of two display lenses rested on his forehead, reflecting distorted light back onto his traditional monitors. He rubbed his eyes with his left hand thoroughly. With his right, he removed the cap, folded it, and placed it onto the charging dock.
...
Ramona opened her mouth to respond, then paused. After a few seconds she finally spoke. "It's been a really long time. It will be really weird to be back. I'd really like you there with me." She squeezed his hand.
...
"It just takes time. It's like typing, you just need to practice. Remember covering all the letters so you force your fingers to learn it? Except, it goes both ways. It has to learn your activation space and differentiate the signals." Sam said.
...
Glenn opened his mouth to speak, but Dorothea jumped the queue. "You're not going to believe the compute budget. We're not even making a dent in it. This whole world is rendered, not just what we can see. The state is updated every nanosecond, and it can roll back over a ten thousand years, if I'm tailing these logs correctly." She glanced over to Glenn for approval, but stood down as she saw him motionless, side-eyed with raised eyebrows.

Glenn held her gaze for an extra beat before snapping back into it. He addressed Sam, still gawking at the threads of rope on the perimeter of the boat. "11,384 years, and counting, though that's just the arbitrary starting point of this particular instance. We have thousands running in parallel, but this was the most appropriate for your onboarding."
...
<!-- TODO (Dan, 2026-08-31): chapter currently runs through beat F (seal test / Judas / Dorothea trial-pruning), ending on Dorothea getting "flipped" into a regular sim citizen. Keep the beats — don't cut them — but reorganize: this chapter should read as fun-and-games onboarding, not a "no going back" decision (that decision already happened in the Pickup chapter). Figure out where beat F's material actually belongs / how the chapter should land instead. -->
...
"I think there's a mouse or something by those bushes!", Sam pointed and leaned closer.
...
"I'd imagine that's why rabbits are so nervous."
...
Sam replied without looking at Ramona. "I went skiing once in the clouds. It felt kind of like floating for the stretches I could stay up, but I fell on my ass about every 12 seconds. The snow was really cold, and wetter than I expected... I can't believe how many lifts are still rusting out there. It seems the whole town would have had to ski at the same time."
...
│  TRANSIT SERVICE RECEIPT                           GONDOLA LINE 4   │
  ├──────────────────────────────────────────────────────────────────────┤
  │                                    ESTIMATED              ACTUAL    │
  │  ────────────────────────────────────────────────────────────────── │
  │  DEMAND                                                             │
  │    Peak                          1,080.0 kW          1,103.4 kW     │
  │    Rate                    0.32000 mETH/kW    0.34500 mETH/kW   │
  │    Subtotal                  0.34560000 ETH       0.38067300 ETH    │
  │                                                                     │
  │  ENERGY                                                             │
  │    Consumed                      358.0 kWh            372.6 kWh     │
  │    Rate                  1.15000 mETH/kWh   1.18200 mETH/kWh    │
  │    Subtotal                  0.41170000 ETH       0.44041320 ETH    │
  │  ────────────────────────────────────────────────────────────────── │
  │  SERVICE TOTAL                   0.75730000 ETH       0.82108620 ETH│
  │  Passengers                              11                   11    │
  │  ────────────────────────────────────────────────────────────────── │
  │  YOUR SHARE                      68.84545 mETH       7.464420 mETH│
  │  Tax (3%)                        2.06536 mETH                2.23933 mETH│
  │  ══════════════════════════════════════════════════════════════════ │
...
It was enormous segmented rings. Each ring was thirty meters in diameter, receding into the distance like vertebrae. A rusting machine lying dead on its side.
...
Inside was a decrepit concrete slab poured at a 30 degree incline, with two rusted cellar doors. It was padlocked in a three places and likely wouldn't open even if it wasn't. Ramona checked her paper one more time and took something from her pocket. She slid the something along the side of one of the cellar doors shakily until an actuator clicked softly. The entire slab hinged open, slowly and utterly silent. Steel stairs descended into dark. As Ramona stepped down soft lights illuminated the staircase.
...
All along the perimeter of the tunnel was what looked like mesh netting, stapled into place every few meters. The air surprisingly wasn't stale—a steady flow of air was at their backs. The tunnel had a chalky, damp smell.

They didn't venture far into the darkness before occupancy sensors triggered lighs further down their path. They walked for a long time in silence, Ramona occasionally checking her little treasure map as the tunnel branched and forked. They ignored any door that wasn't on Ramona's map. The right direction was nearly always further down, and further in.
...
Lining the stone waterfall on down each side for innumerable levels was a mix of walkways and floor-to-ceiling windows for what appeared to be living quarters. Floor after floor of windows, like a a skyscraper had been unfurled and wrapped outside-in around the gaping donut hole in the mountain.

They took the first elevator that came, which gave a perfect view of the old mine shaft.  He people-watched floor after floor. Some had blinds closed and he could only see silhouetted shapes behind, others were more voyeuristic. As they descended he saw people working at terminals, lifting weights, running, sleeping, fucking. They kept moving down. His ears popped and he realized he'd been missing out on a conversation between Tina and Ramona.

"It would be nice to see him first. I'm not sure if I'm ready to go back to our chamber quite yet." Ramona mentioned to her sister.

Tina illuminated L86, and deselected L174 further below. He noticed the levels went top to bottom from 27 to 0, then L1 down to L218. He felt stupid not having checked the floor they came in on. Another worker came into the elevator on L80, selected L101, and greeted Ramona. Then he glanced at Sam and Tina and became visibly confused.

They disembarked on L86 into an offensively white room, very well lit. The ceiling was 10 meters high or so, like 3 regular levels. The sound of running water was everywhere, seemingly in the walls. The earth smell was overwhelming. Floor to ceiling were crops, growing out of pockmarked PVC pipe, stepped like ladders vertically. The ends of the PVC had various smaller pipes and valves on the ends. Between the racks were people on lifts working with the plants on various levels. The lifts hung from gimbals on the ceilings that moved smoothly between the racks.
...
>
> The Chief dismisses most people, keeps his right-hand man. Pleasant exchange about Ramona's return, condolences about her father. Then: "Sit down. Any guesses why you're here?"
>
...
>
> **The real world:** Coffee Guy in the break room, getting coffee while automated systems cascade through global infrastructure. He never thinks about the 847M simulated deaths. They're just data points. Failed trials.
>
> **The data center:** Silence. A warehouse in Ashburn, Virginia. An LED blinks green. Zoom out: electron through silicon gate, transistor, logic gate, RAM, server, rack, row, cooling system, atmosphere, weather front, satellite, Earth, solar system, galaxy, observable universe. Hold. Zoom back in. The LED. The hidden container. The server that never shuts down. $0.37/month.
>
